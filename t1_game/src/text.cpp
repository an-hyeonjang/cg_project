...
static const char*	font_path = "C:/Windows/Fonts/georgia.ttf";
...
void render_text(std::string text, GLint _x, GLint _y, GLfloat scale, vec4 color, float sleep, GLFWwindow* window)
{
	// Activate corresponding render state	
	extern ivec2 window_size;
	GLfloat x = GLfloat(_x);
